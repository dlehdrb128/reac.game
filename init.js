...
const startClickHanlder = () => {
  ...
  setInterval(() => {
    let ran1 = Math.random() * 20 + 1;
    ran1 = Math.floor(ran1);

    let ran2 = Math.random() * 20 + 1;
    ran2 = Math.floor(ran2);

    let ran3 = Math.random() * 20 + 1;
    ran3 = Math.floor(ran3);

    let ran4 = Math.random() * 20 + 1;
  ...
  ball1DOM.marginLeft = 0;
  ball2DOM.marginLeft = 0;
  ball3DOM.marginLeft = 0;
  ball4DOM.marginLeft = 0;
};
